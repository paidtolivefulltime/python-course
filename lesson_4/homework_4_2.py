...
result_1 = ''
for i in range(3):
    result_1 += name_1 # append right variable and reassign value to left variable
print(result_1)
...
string_number_1 = input('Enter Number: ')
result_3 = 0
...
# Ex. 4
# Create code which sums up all even numbers between 2 and 100 (include 100)
