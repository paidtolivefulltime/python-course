...
result_2 = None
if number_1 > 0 and number_1 <= 5 and number_2 > 0 and number_2 <= 5:
    result_2 = number_1 * number_2
elif number_1 > 5 and number_1 <=10 and number_2 > 0 and number_2 <= 5:
    result_2 = number_1 + number_2
elif number_1 > 0 and number_1 <= 5 and number_2 > 5 and number_2 <= 10:
    result_2 = number_1 + number_2
...
elif random_number >= 10 and random_number <= 99:
    result_4 = random_number % 2
    if result_4 == 0:
        result_4 = 'Even number'
    else:
        result_4 = 'Odd number'
print(random_number, result_4)
