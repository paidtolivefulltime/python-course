...
elif (number_1 > 5 and number_1 <= 10 and not (number_2 > 5 and number_2 <= 10)) \
        or (number_2 > 5 and number_2 <= 10 and not (number_1 > 5 and number_1 <= 10)):
    result_2 = number_1 + number_2
