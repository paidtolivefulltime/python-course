...
elif age < 16: result_5 = 'You can go Trick-or-Treating'
print(age, result_5)
...
result_month = None
if month == 1: result_month = 'January'
elif month == 2: result_month = 'February'
elif month == 3: result_month = 'March'
elif month == 4: result_month = 'April'
elif month == 5: result_month = 'May'
elif month == 6: result_month = 'June'
elif month == 7: result_month = 'July'
elif month == 8: result_month = 'August'
elif month == 9: result_month = 'September'
elif month == 10: result_month = 'October'
elif month == 11: result_month = 'November'
elif month == 12: result_month = 'December'
print(month, result_month)